<section class="o-section o-section--header  t-section  t-section--header">
	<div class="c-header">
		...
		<div class="o-container">
			<div class="o-section__container news-home">
					...
					<div class="c-header__inner-header">
						<div class="c-header__avatar">
							<div class="a-header  c-avatar">
								<img class="c-avatar__img" src="<?php echo get_template_directory_uri() . "/public/images/me-256.jpg"; ?>" alt="">
							</div>
						</div>
					</div>
				</header>
								...
								<div class="c-brand">
									<h1 class="c-brand__title  t-title">
					                    <span class="c-brand__sizer">
					                      <span class="a-header  c-brand__first-word  t-title__first-word"> lloan alberto </span>
					                      <span class="a-header  c-brand__second-word  t-title__second-word"> alas delfin </span>
					                    </span>
									</h1>
